...
class FriendshipRequest(models.Model):
    ...
    from_user = models.ForeignKey(Guest, related_name='friendship_requests_sent')
    to_user = models.ForeignKey(Guest, related_name='friendship_requests_received')
...
class Follow(models.Model):
    ...
    follower = models.ForeignKey(Guest, related_name='following')
    followee = models.ForeignKey(Guest, related_name='followers')
    created = models.DateTimeField(default=timezone.now)
